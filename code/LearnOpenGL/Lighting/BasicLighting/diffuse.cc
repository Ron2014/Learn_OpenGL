...
int main(int argc, char *argv[]) {
  ...
  GLFWwindow* window = glfwCreateWindow(WIN_WIDTH, WIN_HEIGHT, "Diffuse Lighting", NULL, NULL);
  if (window == NULL)
  {
  ...
  shader[IDX_OBJ] = new Shader("vertex_diffuse.shader", "fragment_diffuse.shader");
