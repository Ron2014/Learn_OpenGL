...
int main(int argc, char *argv[]) {
  ...
  GLFWwindow* window = glfwCreateWindow(WIN_WIDTH, WIN_HEIGHT, "Ambient Lighting", NULL, NULL);
  if (window == NULL)
  {
  ...
  shader[IDX_OBJ] = new Shader("vertex_lighted.shader", "fragment_ambient.shader");
