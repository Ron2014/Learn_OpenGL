...
int main(int argc, char *argv[]) {
  ...
  GLFWwindow* window = glfwCreateWindow(WIN_WIDTH, WIN_HEIGHT, "LightingMap0", NULL, NULL);
  if (window == NULL)
  {
  ...
  shader[IDX_OBJ] = new Shader("vertex_specular.shader", "fragment_lighting_map.shader");
