...
int OBJ_IDXS[] = {IDX_MODEL, IDX_PLANET};
...
void initShaders() {
  ...
  shader[IDX_MODEL] = new Shader("vertex_instanced_model.shader", "fragment_model_in_lights.shader");
  shader[IDX_PLANET] = new Shader("vertex_specular.shader", "fragment_model_in_lights.shader");
