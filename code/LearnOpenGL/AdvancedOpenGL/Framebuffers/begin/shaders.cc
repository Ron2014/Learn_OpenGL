...
void initShaders() {
  ...
  shader[IDX_PLANE] = new Shader("vertex_normal.shader", "fragment_texture.shader");
  ...
  shader[IDX_DBUG] = new Shader("vertex_normal2d.shader", "fragment_texture_screen.shader");
