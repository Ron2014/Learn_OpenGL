...
void initShaders() {
  ...
  shader[IDX_CUBE] = new Shader("vertex_specular.shader", "fragment_skybox_reflect.shader");
  shader[IDX_LAMP] = new Shader("vertex_lighted.shader", "fragment_lamp.shader");
  shader[IDX_MODEL] = new Shader("vertex_specular.shader", "fragment_skybox_reflect.shader");
