...
void framebuffer_size_callback(GLFWwindow* window, int width, int height)
{
  ...
  projection = glm::perspective(glm::radians(fov), (WIN_WIDTH*1.0f)/WIN_HEIGHT, 0.1f, 1000.0f);
...
int main(int argc, char *argv[]) {
  ...
  GLFWwindow* window = glfwCreateWindow(WIN_WIDTH, WIN_HEIGHT, "CameraZoom", NULL, NULL);
  if (window == NULL)
  {
